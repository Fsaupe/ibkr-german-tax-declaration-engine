...
- [EStG 22 Nr. 3 -- Einkuenfte aus Leistungen](tax-law/estg-22-nr3-leistungen.md) -- The residual income type the order of enquiry at [GT-ESTG20-049] ends in: a benefit granted for placing capital is a Leistung, not Kapitalertrag [GT-ESTG20-063]; valuation and Zufluss of a benefit in kind [GT-ESTG20-064]; the amount taxed on receipt becomes the Anschaffungskosten [GT-ESTG20-065]; the order of a same-day award reversal and a disposal is not fixed by law [GT-ESTG20-066]; the return of a taxed benefit when its condition fails [GT-ESTG20-067]. The § 22 Nr. 3 vs § 20 Nr. 7 classification (Q19) and the return treatment (Q20) are open questions
