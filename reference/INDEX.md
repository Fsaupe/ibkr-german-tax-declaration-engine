...
- [EStG 20 -- Kapitalvermoegen](tax-law/estg-20-kapitalvermoegen.md) -- Central statute for all capital income (dividends, gains, options, corporate actions); also hosts whose holding is declared, which lot a disposal consumes, and what the Anschaffungskosten comprise -- the Nebenkosten of the purchase, a commission or a transaction tax, via § 255 Abs. 1 Satz 2 HGB and BMF 14.05.2025 Rz. 93-94 [GT-ESTG20-068]; a reduction attributable to the purchase is subtracted, also a third party's -- § 255 Abs. 1 Satz 3 HGB, BFH IX R 46/03 -- and its unsettled boundary against § 20 Abs. 3 Satz 2 (Q21) [GT-ESTG20-069]
