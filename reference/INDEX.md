...
- [DBA Deutschland -- USA: Dividenden und Anrechnung](tax-law/dba-usa.md) -- the US treaty rate on a dividend or payment in lieu to a German private investor (Art. 10 Abs. 2 b, 15 %) [GT-CREDIT-027], the credit article (Art. 23 Abs. 3 b aa) and the Art. 21 residual, and both treaty readings of a substitute payment: 15 % creditable on the Art. 10 reading, the Art. 21 reading open (Q22) [GT-CREDIT-028]
