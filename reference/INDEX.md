...
- [DBA Deutschland -- USA: Dividenden und Anrechnung](tax-law/dba-usa.md) -- the US treaty rate on a dividend or payment in lieu to a German private investor (Art. 10 Abs. 2 b, 15 %; for a REIT only under the holding conditions of Abs. 4 Satz 3; for a RIC not on the part of a dividend the RIC reports as exempt under 26 U.S.C. § 871(k); REIT status held per taxable year, § 856(c)(1)) [GT-CREDIT-027], the credit article (Art. 23 Abs. 3 b aa) and the Art. 21 residual, and both treaty readings of a substitute payment: 15 % creditable on the Art. 10 reading, the Art. 21 reading open (Q23) [GT-CREDIT-028]
