...
| Q17 | Whether shares awarded under a one-year transfer restriction and a reclaim condition zufliessen on the booking or on the lapse | **Not a question of law, and not an election.** The law is settled on both sides of one line -- BMF 01.06.2024 Rn. 25-26, § 19a Abs. 1 Satz 4 EStG a contrario, BFH VI R 37/09, VI R 67/05, VI R 6/18, IX R 56/13 -- and what remains is its application to one programme's terms. That application puts Zufluss on the lapse of the restriction: the terms declare a premature disposal *"void"* and the custodian refuses it, so the restriction goes to the effectiveness of a disposal (VI R 37/09 Rn. 15, 20). Its grounds, clause by clause, and its limits -- no German court or administrative statement on this programme -- are stated at the claim. Briefly recorded as open on 2026-09-20 while the application was unfinished; retired the same day | [GT-ESTG20-064] |
