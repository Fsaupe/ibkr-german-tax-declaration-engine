...
| Q22 | [GT-CREDIT-028], [GT-CREDIT-026] | Where a US payment in lieu is Art. 21 income (attribution passed to the borrower), is the US tax creditable at 15 % -- the refund the US grants under its own law (Rn. 207a; § 32d Abs. 5 Satz 1 names no separate treaty-conformity condition, unlike § 34c Abs. 6 Satz 2) -- or not at all, because the whole of it is reducible *"aufgrund eines DBA"* (BZSt Erlaeuterungen)? | `../tax-law/dba-usa.md` |
