...
| Shares awarded for bringing assets to a broker (**one programme only: IBKR "Refer-A-Friend"**) | EStG 22 Nr. 3; 8 Abs. 2 S. 1; 11 Abs. 1 S. 1, Abs. 2 S. 1; 20 Abs. 4 S. 1 with HGB 255 Abs. 1 S. 1; 19a Abs. 1 S. 4 (a contrario) | **Category:** Veranlassung test, BFH VIII R 7/23 Rn. 20; BMF 14.05.2025 Rz. 129b ¶1 for the neighbouring case. **Zufluss:** BMF 01.06.2024 Rn. 25-26, BFH VI R 37/09, VI R 67/05, VI R 6/18 -- applied to the quoted terms: the day the transfer restriction lapses, because the *"void"* clause and the custodian's refusal go to the effectiveness of a disposal (VI R 37/09 Rn. 15, 20). **Anschaffungskosten:** BMF 06.03.2025 Rn. 75 and BMF 14.05.2025 Rz. 87, both analogies. **Return:** EStH H 22.8, BFH IX R 26/14 Rn. 20, VI R 6/18 Rn. 37-40, VI R 17/08 Ls. 2 | Anlage SO (Leistungen) for the receipt and a return -- **Zeilen not held in this library**; Anlage KAP Z19-23 for the later disposal | tax-law/estg-22-nr3-leistungen.md [GT-ESTG20-063], [GT-ESTG20-064], [GT-ESTG20-065], [GT-ESTG20-066], [GT-ESTG20-067] |
