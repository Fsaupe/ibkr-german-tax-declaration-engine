...
| Foreign WHT above the treaty rate | EStG / DBA | 32d Abs. 5 Satz 1 credits the withheld tax *um einen entstandenen Ermaessigungsanspruch gekuerzt*, grounded in the source state's law or a DBA (BMF Rn. 207a, BZSt); § 32d Abs. 5 names no separate treaty-conformity condition, unlike § 34c Abs. 6 Satz 2 | KAP Z41 at the creditable rate (excess not creditable, reclaimed in the source state) | estg-32d-abgeltungsteuer.md [GT-CREDIT-026]; dba-usa.md [GT-CREDIT-027] (US dividend 15 %; a REIT's only under the holding conditions of Art. 10 Abs. 4 Satz 3), [GT-CREDIT-028] (Art. 23/21; Art. 10 reading 15 %, Art. 21 reading open, Q22); bmf-guidance/bzst-anrechenbare-quellensteuer.md [GT-CREDIT-029] (share dividends: FR 12,8, JP/CA/KR/NL 15, TW 10), [GT-CREDIT-030] (interest: IE 0), per edition 2023-2026. Other interest and every other source state unsourced |
