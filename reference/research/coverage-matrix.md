...
| A credit booked on a single trade (net commission positive) | HGB / EStG | 255 Abs. 1 S. 3 HGB with BFH IX R 46/03 and, for the nearest case, BMF 14.05.2025 Rz. 129b third paragraph (purchase); **not settled** against 20 Abs. 3 S. 2, nor for a disposal -- Q21 | (the security's gain, or general capital income: that is the question) | estg-20-kapitalvermoegen.md [GT-ESTG20-069] |
