...
| Shares received as a benefit for placing capital | EStG 22 Nr. 3 (chosen) / 20 Abs. 1 Nr. 7 (open, Q19); 8 Abs. 2 S. 1; 11 Abs. 1 S. 1 | BMF 14.05.2025 **Rz. 129b** ¶1 supports § 22 Nr. 3 by analogy (a *depot* transfer; not a cash deposit left in place, so it does not settle it); BFH VIII R 18/20 supports the § 20 Nr. 7 side. **Open:** Q19 (Nr. 3 vs Nr. 7 classification, taxpayer chose Nr. 3), Q20 (treatment of a returned benefit), Q16 (basis of a Freigrenze-exempt receipt) | Anlage SO (Leistungen) for the receipt -- **Zeilen not held in this library**; Anlage KAP Z19-23 for the later disposal | tax-law/estg-22-nr3-leistungen.md [GT-ESTG20-063], [GT-ESTG20-064], [GT-ESTG20-065], [GT-ESTG20-066], [GT-ESTG20-067] |
