...
| Foreign WHT above the treaty rate | EStG / DBA | 32d Abs. 5 Satz 1 credits the withheld tax *um einen entstandenen Ermaessigungsanspruch gekuerzt*, judged by the source state's law (BMF Rn. 207a, BZSt); § 32d Abs. 5 has no § 34c Abs. 6 Satz 3 analogue | KAP Z41 at the treaty rate (excess not creditable, an IRS-refund matter) | estg-32d-abgeltungsteuer.md [GT-CREDIT-026]; dba-usa.md [GT-CREDIT-027] (US dividend 15 %), [GT-CREDIT-028] (Art. 23/21, both substitute-payment readings). US only in the store; other source states unsourced |
