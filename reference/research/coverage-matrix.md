...
| Internal transfer (Depotübertragung) | securities (long & short) & non-EUR cash | Parsed from IBKR Transfers export; tax-neutral lot move (cost basis / open-short proceeds + acquisition/opening date carried over, §43 Abs. 1 S. 5). Historical SoY reconstruction replays trades and transfers in a single chronological stream, so a security bought, transferred between Depots and (partly) sold all within the historical window is rebuilt lot-exactly. | estg-20-kapitalvermoegen.md (Abs. 4) |
