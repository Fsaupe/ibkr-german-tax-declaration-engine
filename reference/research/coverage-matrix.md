...
| Shares received as a benefit for placing capital | EStG 22 Nr. 3; 8 Abs. 2 S. 1; 11 Abs. 1 S. 1; 20 Abs. 1 Nr. 7 (the boundary) | BMF 14.05.2025 **Rz. 129b** -- a premium for a capital move is § 22 Nr. 3; the ¶2 cost-reduction applies only where the premium is conditioned on a securities purchase, which this benefit is not. Open: Q16 (basis of a Freigrenze-exempt receipt); the vesting-period condition itself | Anlage SO (Leistungen) for the receipt -- **Zeilen not held in this library**; Anlage KAP Z19-23 for the later disposal | tax-law/estg-22-nr3-leistungen.md [GT-ESTG20-063], [GT-ESTG20-064], [GT-ESTG20-065], [GT-ESTG20-066] |
