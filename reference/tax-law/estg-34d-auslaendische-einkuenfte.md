...
**Abs. 6 -- the treaty cases carry the same carve-out.** Satz 1 switches Abs. 1 to 3 off where a DBA
exists, subject to Saetze 2 to 6. **Satz 2:** *"Soweit in einem Abkommen zur Vermeidung der
Doppelbesteuerung die Anrechnung einer auslaendischen Steuer auf die deutsche Einkommensteuer
vorgesehen ist, sind Absatz 1 Satz 2 bis 5 und Absatz 2 entsprechend auf die nach dem Abkommen
anzurechnende und um einen entstandenen Ermaessigungsanspruch gekuerzte auslaendische Steuer
anzuwenden; das gilt nicht fuer Einkuenfte, auf die § 32d Absatz 1 und 3 bis 6 anzuwenden ist; bei
nach dem Abkommen als gezahlt geltenden auslaendischen Steuerbetraegen sind Absatz 1 Satz 3 und
Absatz 2 nicht anzuwenden."* It names two separate conditions on the treaty credit -- the tax
*"nach dem Abkommen anzurechnende"* and *"um einen entstandenen Ermaessigungsanspruch gekuerzte"* --
and its second Halbsatz withdraws it from Abgeltungsteuer income in the same terms as Abs. 1 Satz 1.
**Satz 3:** *"Absatz 1 Satz 3 gilt auch dann entsprechend, wenn die Einkuenfte in dem auslaendischen
Staat nach dem Abkommen zur Vermeidung der Doppelbesteuerung mit diesem Staat nicht besteuert werden
koennen."* -- it extends the exclusion from the *auslaendische Einkuenfte* used for the
Anrechnungshoechstbetrag; it does not itself reduce the tax credited. Saetze 4 to 6 (a DBA not
covering the tax, § 50d Abs. 9, taxation of income not sourced in the treaty state) are not quoted
here and have not been examined against Abgeltungsteuer income. Retrieved 2026-09-22 from
gesetze-im-internet.de/estg/__34c.html.
