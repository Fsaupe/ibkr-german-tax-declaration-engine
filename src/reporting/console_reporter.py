...
def generate_console_tax_report(
    ...
    print("  Zeile 41 trägt die anrechenbare ausländische Steuer: bei Dividenden auf den anrechenbaren Satz der BZSt-Übersicht des Steuerjahres begrenzt, soweit für Jahr und Quellenstaat recherchiert; sonst (andere Staaten, Zinsen, nicht recherchierte Jahre) die einbehaltene Steuer. Über dem anrechenbaren Satz Einbehaltenes und ungeprüfte Quellenstaaten werden unten als Hinweis ausgewiesen. Die §32d-Abs.5-Höchstbeträge wendet das Finanzamt an.")
