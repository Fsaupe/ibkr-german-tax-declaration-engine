...
would all change (Reading A). The maintainer selected Reading B on 2026-09-21, based on
actual shares booked and ordinary dividends received; the grounds and the counterargument
are recorded in the map row. The pipeline discloses the position for historical awards too.
"""
import logging
