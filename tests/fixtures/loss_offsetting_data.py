...
LOSS_OFFSETTING_TESTS: List[LossOffsettingTestCase] = [
    ...
    LossOffsettingTestCase(
        ...
        expected=ExpectedReportingFigures(
            ...
            form_so_p23_net_gv=D("600.00"),  # 800 - 200
