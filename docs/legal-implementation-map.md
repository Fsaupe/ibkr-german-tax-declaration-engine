...
|---|---|---|---|---|
| GT-ESTG20-075 | **deviates** | `option_processor.py`, `trade_processor.py`, historical replay and option delivery linking | Existing stock-holder tests cover current stock exercise only; `test_option_premium_tax_treatment.py` demonstrates the historical gap | Issue #85: extend paid holder costs to historical and fund paths; keep writer premiums separate. Requirement prepared before application changes on 2026-09-22. |
