...
| GT-ESTG23-012 | deviates for VZ 2025 form placement | `SECTION_23_ESTG_TAXABLE_GAIN` / `_TAXABLE_LOSS` / `_EXEMPT_HOLDING_PERIOD_MET`; report destination tracked at GT-FORM-020 | `test_section23_holding_period_guards.py::TestSpeculationPeriodFlagIsTruthful` | 2026-09-23: annual form verification establishes allocation line 58 for VZ 2025. Issue #79 will correct the unconditional line 54 label. Holding-period classification is unchanged. |
...
| Claim | Position | Module | Guarding tests | Notes |
|---|---|---|---|---|
| GT-FORM-020 | deviates for VZ 2025 | § 23 gains and losses → unconditional Zeile 54 | `test_section23_holding_period.py` (holding period only; does not guard placement) | 2026-09-23: independently read official sheets 2023AnlSO133NET, 2024AnlSO133NET, 2025AnlSO133NET. Allocation is Z54/Z54/Z58, distinct from the disposal calculation at Z53/Z53/Z57 and further-disposal schedule at Z55/Z55/Z59. Issue #79 corrects the VZ 2025 report destination; no arithmetic change. |
